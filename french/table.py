...
("parler","elle"):["Elle parle.","Ella a parlé.","Elle parlait.","Ella avait parlé.","Elle parlera.","qu'elle parle.","qu'elle ait parlé.","elle parlerait.","elle aurait parlé.","n/a"],
...
("changer","tu"):["Tu changes.","Tu as changé.","Tu changeais.","Tu avais changé.","Tu changeras.","que tu changes.","que tu aies changé.","tu changerais.","tu aurais changé.","Change !"],
...
("s'appeler","elle"):["Elle s'appelle.","Elle s'est appelée.","Elle s'appelait.","Elle s'était appelée.","Elle s'appellera.","qu'elle s'appelle.","qu'elle se soit appelée.","elle s'appellerait.","elle se serait appelée.","n/a"],
...
("s'appeler","vous"):["Vous vous appelez.","Vous vous êtes appelés.","Vous vous appeliz.","Vous vous étiez appelés.","Vous vous appellerez.","que vous vous appeliez.","que vous vous soyez appelés.","vous vous appelleriez.","vous vous seriez appelés.","Appelez-vous !"],
...
("espérer","il"):["Il espère.","Il a espéré.","Il espérait.","Il avait espéré.","Il espérera.","qu'il espère.","qu'il ait espéré.","il espérerait.","il aurait espéré.","n/a"],
...
("se promener","tu"):["Tu te promènes.","Tu t'es promené.","Tu te promenais.","Tu t'etais promené.","Tu te promèneras.","que tu te promènes.","que tu te soit promené.","tu te promènerais.","tu te serais promené.","Promène-toi !"],
...
("procéder","tu"):["Tu procèdes.","Tu as procédé.","Tu procédais.","Tu avais procédé.","Tu procéderas.","que tu procèdes.","que tu aies procédé.","te procéderais.","tu aurais procédé.","Procède !"],
...
("partir","elle"):["Elle part.","Elles est partie.","Elle partait.","Elle était partie.","Elle partira.","qu'elle parte.","qu'elle soit partie.","elle partirait.","elle serait partie.","n/a"],
...
("sentir","elle"):["Elle sent.","Ella a senti.","Elle sentait.","Ella avait senti.","Elle sentira.","qu'elle sente.","qu'elle ait senti.","elle sentirait.","elle aurait senti.","n/a"],
...
("mentir","elle"):["Elle ment.","Ella a menti.","Elle mentait.","Ella avait menti.","Elle mentira.","qu'elle mente.","qu'elle ait menti.","elle mentirait.","elle aurait menti.","n/a"],
...
("tenir","il"):["Il tient.","Il a tenu.","Il tenait.","Il avait tenu.","Il tiendra.","qu'il tienne.","qu'il ait tenu.","il tiendrait.","il aurait tenu.","n/a"],
("tenir","elle"):["Elle tient.","Elle a tenu.","Elle tenait.","Elle avait tenu.","Elle tiendra.","qu'elle tienne.","qu'elle ait tenu.","elle tiendrait.","elle aurait tenu.","n/a"],
...
("se souvenir","vous"):["Vous vous souvenez.","Vous vous êtes souvenus.","Vous vous souveniez.","Vous vous étiez souvenus.","Vous vous souviendrez.","que vous vous souveniez.","que vous vous soyez souvenus.","vous vous souviendriez.","vous vous seriez souvenus.","Souvenez-vous !"],
...
("recevoir","elle"):["Elle reçoit.","Elle a reçu.","Elle recevait.","Elle avait reçu.","Elle recevra.","qu'elle recoive.","qu'elle ait reçu.","elle recevrait.","elle aurait reçu.","n/a"],
...
("s'apercevoir","elle"):["Elle s'aperçoit.","Elle s'est aperçue.","Elle s'apercevait.","Elle s'était aperçue.","Elle s'apercevra.","qu'elle s'apercoive.","qu'elle se soit aperçue.","elle s'apercevrait.","elle se serait aperçue.","n/a"],
...
("s'apercevoir","vous"):["Vous vous apercevez.","Vous vous êtes aperçus.","Vous vous aperceviez.","Vous vous étiez aperçus.","Vous vous apercevrerz.","que vous vous aperceviez.","que vous vous soyez aperçus.","vous vous apercevriez.","vous vous seriezaperçus.","Apercevez-vous !"],
...
("courir","il"):["Il court.","Il a couru.","Il courait.","Il avait couru.","Il courra.","qu'il coure.","qu'il ait couru.","il courrait.","il aurait couru.","n/a"],
...
("parcourir","il"):["Il parcourt.","Il a parcouru.","Il parcourait.","Il avait parcouru.","Il parcourra.","qu'il parcoure.","qu'il ait parcouru.","il parcourrait.","il aurait parcouru.","n/a"],
...
("faire","tu"):["Tu fais.","Tu as fait.","Tu faisais.","Tu avais fait.","Tu feras.","que tu fasses.","que tu aies fait.","tu ferais.","tu aurais fait.","Fais !"],
...
("mettre","tu"):["Tu mets.","Tu as mis.","Tu mettais.","Tu avais mis.","Tu mettras.","que tu mettes.","que tu aies mis.","tu mettrais.","tu aurais mis.","Mets !"],
...
("se permettre","elle"):["Elle se permet.","Elle s'est permis.","Elle se permettait.","Elle s'etait permis.","Elle se permettra.","qu'elle se permette.","qu'elle se soit permis.","elle se permettrait.","elle se serait permise.","n/a"],
...
("attendre","elle"):["Elle attend.","Elle a attendu.","Elle attendait.","Elle avait attendu.","Elle attendra.","qu'elle attende.","qu'elle ait attendu.","elle attendrait.","elle aurait attendu.","n/a"],
...
("rendre","elle"):["Elle rend.","Elle a rendu.","Elle rendait.","Elle avait rendu.","Elle rendra.","qu'elle rende.","qu'elle ait rendu.","elle rendrait.","elle aurait rendu.","n/a"],
...
("écrire","tu"):["Tu écris.","Tu as écrit.","Tu écrivais.","Tu avais écrit.","Tu écriras.","que tu écrives.","que tu aies écrit.","tu écrirais.","tu aurais écrit.","Écris !"],
...
("s'inscrire","tu"):["Tu t'inscris.","Tu t'es inscrit.","Tu t'inscrivais.","Tu t'etais inscrit.","Tu t'inscriras.","que tu t'inscrives.","que tu te soit inscrit.","tu t'inscrirais.","tu te serais inscrit.","Inscris-toi !"],
...
("s'inscrire","elle"):["Elle s'inscrit.","Elle s'est inscrite.","Elle s'inscrivait.","Elle s'etait inscrite.","Elle s'inscrira.","qu'elle s'inscrive.","qu'elle se soit inscrite.","elle s'inscrirait.","elle se serait inscrite.","n/a"],
...
("craindre","il"):["Il craint.","Il a craint.","Il craignait.","Il avait craint.","Il craindra.","qu'il crainge.","qu'il ait craint.","il craindrait.","il aurait craint.","n/a"],
...
("se battre","tu"):["Tu te bats.","Tu t'es battu.","Tu te battais.","Tu t'etais battu.","Tu te battras.","que tu te battes.","que tu te soit battu.","tu te battrais.","tu te serais battu.","Bats-toi !"],
...
("combattre","tu"):["Tu combats.","Tu as combattu.","Tu combattrais.","Tu avais combattu.","Tu combattas.","que tu combattes.","que tu aies combattu.","tu combattrais.","tu aurais combattu.","Combats !"],
...
("distraire","tu"):["Tu distrais.","Tu as distrait.","Tu distrayais.","Tu avais distrait.","Tu distrairas.","que tu distraies.","que tu aies distrait.","tu distrairais.","tu aurais distrait.","distrais !"],
("distraire","il"):["Il distrait.","Il a distrait.","Il distrayait.","Il avait distrait.","Il distraira.","qu'il distraie.","qu'il ait distrait.","il distrairait.","il aurait distrait.","n/a"],
("distraire","elle"):["Elle distrait.","Elle a distrait.","Elle distrayait.","Elle avait distrait.","Elle distraira.","qu'elle distraie.","qu'elle ait distrait.","elle distrairait.","elle aurait distrait.","n/a"],
...
("extraire","tu"):["Tu extrais.","Tu as extrait.","Tu extryais.","Tu avais extrait.","Tu extrairas.","que tu extraies.","que tu aies extrait.","tu extrairais.","tu aurais extrait.","Extrais !"],
("extraire","il"):["Il extrait.","Il a extrait.","Il extrayit.","Il avait extrait.","Il extraira.","qu'il extraie.","qu'il ait extrait.","il extrairait.","il aurait extrait.","n/a"],
("extraire","elle"):["Elle extrait.","Elle a extrait.","Elle extrayit.","Elle avait extrait.","Elle extraira.","qu'elle extraie.","qu'elle ait extrait.","elle extrairait.","elle aurait extrait.","n/a"],
...
("accroître","tu"):["Tu accrois.","Tu as accru.","Tu accroissais.","Tu avais accru.","Tu accroîtras.","que tu accroisses.","que tu aies accru.","tu accroîtrais.","tu aurais accru.","Accrois !"],
("accroître","il"):["Il accroit.","Il a accru.","Il accroissait.","Il avait accru.","Il accroîtra.","qu'il accroisse.","qu'il ait accru.","il accroîtrait.","il aurait accru.","n/a"],
("accroître","elle"):["Elle accroit.","Elle a accru.","Elle accroissait.","Elle avait accru.","Elle accroîtra.","qu'elle accroisse.","qu'elle ait accru.","elle accroîtrait.","elle aurait accru.","n/a"],
...
("absoudre","il"):["Il absout.","Il a absous.","Il absolvait.","Il avait absous.","Il absoudra.","qu'il absolve.","qu'il ait absous.","iIl absoudrait.","il aurait absous.","n/a"],
("absoudre","elle"):["Elle absout.","Elle a absous.","Elle absolvait.","Elle avait absous.","Elle absoudra.","qu'elle absolve.","qu'elle ait absous.","elle absoudrait.","elle aurait absous.","n/a"],
...
("dissoudre","il"):["Il dissout.","Il a dissous.","Il dissolvait.","Il avait dissous.","Il dissoudra.","qu'il dissolve.","qu'il ait dissous.","iIl dissoudrait.","il aurait dissous.","n/a"],
("dissoudre","elle"):["Elle dissout.","Elle a dissous.","Elle dissolvait.","Elle avait dissous.","Elle dissoudra.","qu'elle dissolve.","qu'elle ait dissous.","elle dissoudrait.","elle aurait dissous.","n/a"],
...
("être","elle"):["Elle est.","Elle a été.","Elle était.","Elle avait été.","Elle sera.","qu'elle soit.","qu'elle ait été.","elle serait.","elle aurait été.","n/a"],
...
("pouvoir","je"):["Je peux.","J'ai pu.","Je puvais.","J'avais pu.","Je pourrai.","que je puisse.","que j'aie pu.","je purrais.","j'aurais pu.","n/a"],
...
("vouloir","tu"):["Tu veux.","Tu as voulu.","Tu voulais.","Tu avais voulu.","Tu voudras.","que tu veuilles.","que tu aies voulu.","tu voudrais.","tu aurais voulu.","Veux !"],
("vouloir","il"):["Il veut.","Il a voulu.","Il voulait.","Il avait voulu.","Il voudra.","qu'il veuille.","qu'il ait voulu.","il voudrait.","il aurait voulu.","n/a"],
("vouloir","elle"):["Elle veut.","Elle a voulu.","Elle voulait.","Elle avait voulu.","Elle voudra.","qu'elle veuille.","qu'elle ait voulu.","elle voudrait.","elle aurait voulu.","n/a"],
...
("croire","elle"):["Elle croit.","Elle a cru.","Elle croyait.","Elle avait cru.","Elle croira.","qu'elle croie.","qu'elle ait cru.","elle croirait.","elle aurait cru.","n/a"],
...
("s'asseoir","nous"):["Nous nous assoyons.","Nous nous sommes assis.","Nous nous assoyions.","Nous nous étions assis.","Nous nous assoirons.","que nous nous assoyions.","que nous nous soyons assis.","nous nous assoirions.","nous nous serions assis.","Asseyons-nous !"],
("s'asseoir","vous"):["Vous vous assoyez.","Vous vous êtes assis.","Vous vous assoyiez.","Vous vous étiez assis.","Vous vous assoirez.","que vous vous assoyiez.","que vous vous soyez assis.","vous vous assoiriez.","vous vous seriez assis.","Asseyez-vous !"],
("s'asseoir","ils"):["Ils s'assoient.","Ils se sont assis.","Ils s'assoyaientt.","Ils s'étaient assis.","Ils s'assoiront.","qu'ils s'assoient.","qu'ils se soient assis.","ils s'assoiraient.","ils se seraient assis.","n/a"],
...
("pleuvoir","il"):["Il pleut.","Il a plu.","Il pleuvait.","Il avait plu.","Il pleuvra.","qu'il pleuve.","qu'il ait plu.","il pleuvait.","il aurait plu.","n/a"],
...
("prévaloir","tu"):["Tu prévaux.","Tu as prévalu.","Tu prévalais.","Tu avais prévalu.","Tu prévaudras.","que tu prévales.","que tu aies prévalu.","tu prévaudrais.","tu aurais prévalu.","Prévaux !"],
("prévaloir","il"):["Il prévaut.","Il a prévalu.","Il prévalait.","Il avait prévalu.","Il prévaudra.","qu'il prévale.","qu'il ait prévalu.","il prévaudrait.","il aurait prévalu.","n/a"],
("prévaloir","elle"):["Elle prévaut.","Elle a prévalu.","Elle prévalait.","Elle avait prévalu.","Elle prévaudra.","qu'elle prévale.","qu'elle ait prévalu.","elle prévaudrait.","elle aurait prévalu.","n/a"],
...
("se taire","elle"):["Elle se tait.","Elle s'est tue.","Elle se taisait.","Elle s'etait tue.","Elle se taira.","qu'elle se taise.","qu'elle se soit tue.","elle se tairait.","elle se serait tue.","n/a"],
...
("haïr","tu"):["Tu hais.","Tu as haï.","Tu haïssais.","Tu avais haï.","Tu haïras.","que tu haïsses.","que tu aies haï.","tu haïrais.","tu aurais haï.","Hais !"],
